...
def main():
    ...
    st.write("Upload a plant leaf image or take a photo and we'll predict the disease.")
    ...
    if img:
        ...
        fast_img = PILImage.create(img)
        pred_class, pred_idx, outputs = learner.predict(fast_img)
